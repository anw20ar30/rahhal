...
"INSERT IGNORE INTO experiences (category_id,title,hotel_name,description,city,address,image,price_per_night,rating,available_rooms,is_featured) VALUES (1,'الاندماج الكامل مع الجبل','Desert Rock Resort','فيلات محفورة داخل الجبال الصخرية، وواحدة من أكثر المشاريع المعمارية جرأة في الشرق الأوسط.','نيوم','محمية البحر الأحمر، نيوم، المملكة العربية السعودية','desert-rock.jpg',4500.00,5.0,6,1),(9,'النوم داخل فندق من الجليد','ICEHOTEL','فندق يُعاد بناؤه من الثلج والجليد كل عام، وكل جناح يُصمم كعمل فني مختلف بأيدي نحاتين عالميين.','السويد','يوكاسيارفي، السويد','icehotel.jpg',3200.00,4.8,8,1),(3,'جناح تحت سطح البحر','Conrad Maldives Rangali Island','جناح يضع غرفة النوم تحت الماء مباشرة، حيث يمكنك مشاهدة الأسماك والشعاب المرجانية الملونة من سريرك.','المالديف','جزيرة رانغالي، جنوب أتول آري، المالديف','conrad-maldives.jpg',9800.00,5.0,3,1),(10,'منازل معلقة بين الأشجار','Treehotel','غرف على شكل مكعب مرآة أو عش طائر معلقة بين الأشجار، تقدم تجربة معمارية فريدة وسط الغابات الشمالية الهادئة.','السويد','هارادس، شمال السويد','treehotel.jpg',2700.00,4.9,7,1),(9,'فندق عائم داخل سفينة تاريخية','Fingal Hotel','سفينة تاريخية تحولت إلى فندق فاخر عائم، تقدم تجربة بحرية مختلفة تماماً عن الفنادق التقليدية.','إدنبرة','ميناء ليث، إدنبرة، اسكتلندا','fingal-hotel.jpg',3600.00,4.7,5,1)"
];
