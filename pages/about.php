...
$team = [
    ['name' => 'أحمد الشمري', 'role' => 'المؤسس والرئيس التنفيذي', 'image' => 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=300&q=80'],
    ['name' => 'سارة الحربي', 'role' => 'مديرة تجربة العملاء', 'image' => 'https://images.unsplash.com/photo-1494790108755-2616b612b786?w=300&q=80'],
    ['name' => 'محمد القحطاني', 'role' => 'مدير التقنية', 'image' => 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=300&q=80'],
    ['name' => 'نورة العتيبي', 'role' => 'مديرة التسويق', 'image' => 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=300&q=80'],
];
...
<section class="section">
  <div class="container">
    ...
    <div class="text-center mb-5 mt-5">
      <div class="sec-eyebrow"><i class="fas fa-users"></i> فريقنا</div>
      <h2 class="sec-title">من يقود رحّال؟</h2>
      <p class="sec-sub mx-auto">فريق يهتم بالضيافة، التفاصيل، وتجربة المستخدم العربية.</p>
    </div>
